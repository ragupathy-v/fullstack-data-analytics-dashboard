...
function Piechart() {
  ...
  return (
    ...
    <h1 className="chart-heading">Pie chart</h1>
      ...
      <button className="btn btn-primary" name="Piechart" onClick={datacleaning}>
        Pie chart
      </button>
      </div>
      {image && <div className="chart-image-wrapper"><img className="chart-image" src={`data:image/png;base64,${image}`} alt="Piechart" /></div>}
    </div>
    </>
  )
}
